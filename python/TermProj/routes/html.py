...
@html_bp.route("/customers/<int:id>")
def customers_id(id):
...
@html_bp.route("/orders/<int:id>/complete", methods=["POST"])
def complete_order(id):
    ...
    try:
        ...
        db.session.commit()
        return redirect(url_for("html.order_detail", id=id))
